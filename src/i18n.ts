...
const en = {
	...
	// get (observed ceiling well short of the full screen), so this is worded
	// as "enlarge" rather than "maximize" to avoid promising true fullscreen.
	tipMaximize: "Enlarge",
	tipRestore: "Restore size",
	...
	setPopupWidth: "In-app popup width (px)",
	setPopupHeight: "In-app popup height (px)",
	setWinWidth: "Separate window width (px)",
	setWinHeight: "Separate window height (px)",
...
const ja: Record<MsgKey, string> = {
	...
	setPopupWidth: "アプリ内ポップアップの幅 (px)",
	setPopupHeight: "アプリ内ポップアップの高さ (px)",
	setWinWidth: "別ウィンドウの幅 (px)",
	setWinHeight: "別ウィンドウの高さ (px)",
